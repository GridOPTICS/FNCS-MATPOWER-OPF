...
// ======================================================================================================================
         ...
         int nbrows, nbcolumns, ngrows, ngcolumns, nbrrows, nbrcolumns, narows, nacolumns;
         int ncrows, nccolumns, nFNCSelem, noffgelem;
...
// ========================================================================================================================
         ...
         read_load_profile(load_profile_file, real_power_demand);
// ========================================================================================================================
...
//         double mwBusOut_copy[9];
         ...
         for (int i = 0; i < sizeof(subst_output_file_name)/sizeof(subst_output_file_name[0]); i++) {
            snprintf(subst_output_file_name[i], sizeof(subst_output_file_name[i]), "Substation_%2d.csv", i+1);
         ...
         for (int i = 0; i < sizeof(gen_output_file_name)/sizeof(gen_output_file_name[0]); i++) {
            snprintf(gen_output_file_name[i], sizeof(gen_output_file_name[i]), "Generator_%2d.csv", i+1);
