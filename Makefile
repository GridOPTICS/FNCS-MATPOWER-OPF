...
start_MATPOWER: start_MATPOWER.o matpowerintegrator.o
	g++-4.4 -O -g -pthread  -o start_MATPOWER  start_MATPOWER.o matpowerintegrator.o -Wl,-rpath-link,/usr/local/matlab_2013a/bin/glnxa64 -L/usr/local/matlab_2013a/runtime/glnxa64  -lmwmclmcrrt -lm  ./libmpoption.so ./libopf.so -lfncs_api -lzmq
